...
-- Chaque souvenir contient un embedding vectoriel de 64 dimensions
...
CREATE TABLE IF NOT EXISTS memories (
    ...
    embedding vector(64) NOT NULL,       -- Vecteur d'embedding pour la recherche par similarite
...
CREATE TABLE IF NOT EXISTS memory_archives (
    ...
    embedding vector(64) NOT NULL,             -- Embedding moyen normalise L2
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
