// =============================================================================
// lifecycle/psych_report.rs — Neuropsychological report module
//
// Role: Collects a complete snapshot of the agent's psychological state
// at a given point in time, then generates a clinical report via the LLM.
//
// Structure:
//   - PsychSnapshot: 12 clinical domains (JSON serializable)
//   - PsychReport: generated report (text + metadata)
//   - collect_psych_snapshot(): data collection
//   - build_psych_report_system_prompt(): clinician prompt
//   - build_psych_report_user_prompt(): snapshot JSON
// =============================================================================
...
/// Complete snapshot of the psychological state at a given point in time.
/// All numeric values are in percentages (0-100) for readability.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PsychSnapshot {
    /// Timestamp of the capture
    pub timestamp: String,
    /// Cognitive cycle at the time of the capture
    pub cycle: u64,
...
/// Neuropsychological report generated by the LLM.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Lightweight summary of a snapshot for listings
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Lightweight summary of a report for listings
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PsychReportSummary {
    ...
    pub language: String,
    pub token_count_approx: usize,
    /// First lines of the report (preview)
    pub preview: String,
}

/// Formats a [0.0, 1.0] value as a readable percentage
fn pct(v: f64) -> String {
    format!("{:.0}%", (v * 100.0).clamp(0.0, 100.0))
}

impl SaphireAgent {
    /// Collects a complete snapshot of the psychological state.
    ...
    /// Builds the system prompt for the LLM clinician.
...
- Termine par une note globale sur l'etat de sante psychologique."#,
    ...
    /// Builds the user prompt containing the snapshot JSON.
