...
//
// Role : Endpoints GET pour les donnees du monde et les statistiques
...
/// GET /api/world — Retourne les donnees du modele du monde.
pub async fn api_get_world(State(state): State<AppState>) -> impl IntoResponse {
    let mut agent = state.agent.lock().await;
    axum::Json(agent.world_data())
}

/// GET /api/knowledge — Retourne les statistiques de connaissances acquises.
